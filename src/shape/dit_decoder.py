...
class Decoder(nn.Module):
    ...
    def warp(self, input, step=1.0) -> list[torch.Tensor]:
        return self.warper(input, step=step)

    def forward(self, input, output_warped_points=False, output_warping_param=False, step=1.0):
